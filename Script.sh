...
# Interactively change the root password
passwd root

# Replace the entire sshd_config file with custom settings
...
# Remove all config override files from sshd_config.d
rm -f /etc/ssh/sshd_config.d/*

# Reload SSH service to apply new settings
